        ...
        return (
            <span className="flex items-center">
                <span>
                    ...
                    <h2 className="text-sm text-secondary-text">{store?.departament.name}, {store?.municipality.name}</h2>
                </span>
    ...
    return (
        <>
            ...
            >
                ...
                <p className='pb-5 flex items-center '><LuMapPin className='mr-2'/><span className='font-bold'>Dirección:</span>{store?.direction}</p>
                <hr />
